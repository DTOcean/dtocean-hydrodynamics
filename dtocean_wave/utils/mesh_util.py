...
# encoding: utf-8
"""
This module contains the classe used read and visualise the mesh of the WEC structure

.. module:: mesh_utils
   :platform: Windows
   :synopsis: WEC mesh reader, writer and visualizer
...
if __name__=="__main__":
    ...
    path = "..\..\\examples\\inputs_wave\Mesh"
    name = "Buoy.GDF"

    m = Mesh_BEM(name, path=path)
    m.visualise_mesh()
    m.translate(5,0,0)
